...
const collaborationsList = [
  {
    name: "Vodafone",
    descr:
      "Brand campaign and digital experience for a global telecommunications company.",
  },
  {
    name: "Huawei",
  ...
  },
  {
    name: "Nobleblocks",
    descr:
      "Brand identity and product design for a blockchain-based publishing platform.",
  },
  {
    name: "Twotwentyk",
  ...
  },
  {
    name: "NVO",
    descr:
      "Brand identity, product design and motion system for a digital wallet.",
  },
  {
    name: "Velas",
    descr:
      "Brand campaign and digital experience design for a global telecommunications company.",
  },
  {
    name: "Coinpayments",
